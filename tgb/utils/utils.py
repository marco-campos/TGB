...
def get_args():
    ...
    parser.add_argument('--use_edge_type', type=int, help='Use edge type features (1/0)', default=1)
    parser.add_argument('--use_node_type', type=int, help='Use node type features (1/0)', default=1)
